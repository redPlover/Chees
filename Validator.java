public class Validator {
    ...
    public boolean validation(int type, int color, int x1, int x2, int y1, int y2) {
        ...
        if (((color == 0 && Main.whiteTurn && (colorof2 == 1 || colorof2 == -1)) || (color == 1 && !Main.whiteTurn && (colorof2 == 0 || colorof2 == -1)))) {
            if (type == 1) {
                if (((x2 == x1) && colorof2 == -1 && ((y1 - y2 == 1 && Main.whiteTurn) || (y2 - y1 == 1 && !Main.whiteTurn)))
                || (((x2 == x1) && ((y1 - y2 == 2 && state.checkPiece(x2, y2 + 1) == 0 && Main.whiteTurn) || (y2 - y1 == 2 && state.checkPiece(x2, y2 - 1) == 0 && !Main.whiteTurn))) && (y1 == 7 || y1 == 2))
                || (x2 - 1 == x1 && y1 - y2 == 1 && colorof2 == 1)
                || (x2 + 1 == x1 && y1 - y2 == 1 && colorof2 ==1)
                || (x2 - 1 == x1 && y2 - y1 == 1 && colorof2 == 0)
                || (x2 + 1 == x1 && y2 - y1 == 1 && colorof2 ==0)) return true;
                else return false;
            } else if (type == 2) {
                if (x2 == x1 || y2 == y1) {
